  ...
  return (
    <Reveal delay={delay} variant="slide-left">
      <article
        ...
        className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white/80 p-6 shadow-lg shadow-slate-900/5 backdrop-blur-md transition-transform duration-300 ease-out dark:border-slate-800/80 dark:bg-gradient-to-b dark:from-slate-900/80 dark:to-slate-900/40 dark:bg-transparent"
      >
        <div
