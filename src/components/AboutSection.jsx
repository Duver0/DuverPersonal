...
const AboutSection = () => (
  <Reveal variant="blur-in">
    <section id="sobre-mi" className="rounded-3xl border border-slate-100 bg-white/75 p-8 shadow-xl shadow-slate-900/5 backdrop-blur-sm scroll-mt-24 dark:border-slate-800 dark:bg-slate-900/40">
